  ...
  return (
    <div className="flex">
      <div className="flex flex-col flex-1">
         ...
         <Codebox className="mb-1" Component={ Required } />
         <Codebox className="mb-1" Component={ Status } />
      </div>
      <div className="pl-1" style={ { flexBasis: '200px' } }>
        ...
        >
           ...
           <Anchor.Link key={`#${ Required.href}` } title={ Required.anchorTitle } />
           <Anchor.Link key={`#${ Status.href}` } title={ Status.anchorTitle } />
        </Anchor>
      </div>
    </div>
  );
